...
export function getFitnessServiceStatus(
  ...
  if (clientUrl) {
    return "Открывается сервис студии. Условия записи, оплаты и отмены указаны в личном кабинете.";
  }

  return "Демо-приложение: без регистрации, настоящей записи и оплаты. Тестовые действия сохраняются только в вашем браузере.";
}
