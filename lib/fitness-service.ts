...
export function getFitnessServiceStatus(
  ...
  if (clientUrl) {
    return "Личный кабинет подключён: расписание, запись и оплата доступны по кнопке выше.";
  }

  return "Личный кабинет пока не подключён. Реальная ссылка появится после выбора сервиса записи и оплаты.";
}
